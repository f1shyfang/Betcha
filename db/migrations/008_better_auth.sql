-- Better Auth core tables (generated by @better-auth/cli, made idempotent).
-- These are auth-owned. The domain `users` table (001) mirrors `user` via a
-- create hook in lib/auth.js: users.id == user.id.
BEGIN;
